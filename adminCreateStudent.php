...
<html>
    ...
    <center> <h1 class="headerFont">Create/Edit Student</h1> </center>
 ...
 <br>
        ...
        <input type="text" name="FName" required pattern="[^'\x22><]+" title="No Numbers/Symbols" value="<?php echo $FName; ?>"/><br><br>

        <input type='hidden' name="flaginput" value="<?php if($flag==TRUE){ echo 'true'; } else{ echo 'false'; } ?>">
        <label id="lastName">Last Name: </label>
        <input type="text" name="LName" required pattern="[^'\x22><]+" title="No Numbers/Symbols"  value="<?php echo $LName; ?>"/><br><br>
        ...
        <select style="width: 100px;" name="Gender"><?php
                ...
                <input type="text"  pattern="[^'\x22><]+" title="No Numbers/Symbols"  name="citizenship" value="<?php echo $citizenship; ?>"/> <br><br>
                
                <label id="homeProvince" > Home Province: </label>
                <input type="text"  pattern="[^'\x22><]+" title="No Numbers/Symbols" name="homeProvince" value="<?php echo $homeProvince; ?>"/> <br><br>
        ...
        <input type="text" pattern="[^'\x22><]+" title="No Special Characters (Quotes or Angle Brackets)" name="UGProgram" value="<?php echo $UGProgram; ?>"/><br><br>
        ...
        <h4 class="headerfont boldFont">Funding Information</h4> <br>
                ...
                <input type="text" pattern="[^'\x22><]+" title="No Special Characters (Quotes or Angle Brackets)" name="fundingSource" value="<?php echo $Source; ?>"/><br><br><br>

        <h4 class="headerfont boldFont">Post-Grad Information</h4> <br>
                <label id="furtherstudies" >Further Studies: </label>
                <input type="text"  pattern="[^'\x22><]+" title="No Special Characters (Quotes or Angle Brackets)" name="furtherStudies" value="<?php echo $furtherStudies; ?>"/> <br><br>
                
                <label id="futureemployment" >Employment: </label>
                <input type="text"  pattern="[^'\x22><]+" title="No Special Characters (Quotes or Angle Brackets)" name="futureEmployment" value="<?php echo $futureEmployment; ?>"/><br><br><br>
