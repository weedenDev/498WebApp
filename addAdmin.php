...
<fieldset>
	<legend> Add Admin </legend>
		First Name: <input type="text" name="FName" required  pattern="[a-zA-Z` ]+" title="No Numbers/Symbols"> <br><br>
		Last Name: <input type="text" name="LName" required pattern="[a-zA-Z` ]+" title="No Numbers/Symbols"> <br><br>
</fieldset> 
