...
<fieldset>
	...
	StudentID: <input type="number" name="StudentNum" value="<?php echo $StudentID; ?>" required> <br><br>
	Project Title: <input type="text" name="projectTitle" pattern="[^\x22<>]+" value="<?php echo $projectTitle; ?>" required> <br><br>
	Organization: 
	...
	Paid: <input type="radio" name="paid" value="Paid" <?php if($paid=='Paid'){ echo 'checked';} ?>> Yes <input type="radio" name="paid" value="Unpaid" <?php if($paid!='Paid'){ echo 'checked';} ?>> No <br> <br>
	Description: <br> <textarea name="Description" rows="10" cols="100"><?php echo $Description; ?> </textarea> <br> <br>
	Preceptor Name: <input type="text" name="preceptorName" pattern="[a-zA-Z ]+" value="<?php echo $preceptorName; ?>" > <br><br>
	Contact: <input type="text" name="contact" pattern="[a-zA-Z ]+" value="<?php echo $contact; ?>" ><br><br>
	Dominant Competancy Category: <input type="text" pattern="[a-zA-Z ]+" name="DominantCompetencyCategory" value="<?php echo $DominantCompetencyCategory; ?>"> <br><br>
	Applied Area 1: <input type="text" name="appliedArea1" pattern="[a-zA-Z ]+" value="<?php echo $appliedArea1; ?>"> <br><br>
	Applied Area 2: <input type="text" name="appliedArea2" pattern="[a-zA-Z ]+" value="<?php echo $appliedArea2; ?>"> <br><br>
	Applied Area 3: <input type="text" name="appliedArea3" pattern="[a-zA-Z ]+" value="<?php echo $appliedArea3; ?>"> <br><br>
	Population: <input type="text" name="population" pattern="[a-zA-Z ]+" value="<?php echo $population; ?>"> <br><br>
	Task 1: <input type="text" name="task1" pattern="[a-zA-Z ]+" value="<?php echo $task1; ?>" > <br><br>
	Task 2: <input type="text" name="task2" pattern="[a-zA-Z ]+" value="<?php echo $task2; ?>"> <br><br>
	Task 3: <input type="text" name="task3" pattern="[a-zA-Z ]+" value="<?php echo $task3; ?>"> <br><br>
	Role: <input type="text" name="role" pattern="[a-zA-Z ]+" value="<?php echo $role; ?>"> <br><br>
...
<?php
	if(isset($_POST["submit"])){
        ...
        $Description = test_input($_POST["Description"],$con);
