...
if($_SESSION['member_status'] != 'student'){
 ...
 ?>
   <head>
    ...
    <center> <h1 class="headerFont">Epidemiology Student Profile</h1> </center>
...
function test_input($data,$con) {
    ...
    <form method="post">
        <fieldset>
            ...
            Thesis Title: <input type="text" name="thesisTitle" pattern="[^\x22<>]+" value="<?php echo $Title; ?>"> <br>
            Research Area: <input type="text" name="researchArea" pattern="[^\x22<>]+" value="<?php echo $ResearchArea; ?>"> <br>
            Supervisor: <input type="text" name="supervisor" pattern="[^\x22<>]+" value="<?php echo $Supervisor; ?>"><br>
            Defence Committee: <input type="text" pattern="[a-zA-Z ]+" name="defence" readonly="readonly" value="<?php echo $Defence; ?>"> <br>
            Abstract: <br>
    ...
    <?php
        ...
        if(isset($_POST["Submit"])){
            ...
            $Title = test_input($_POST["thesisTitle"],$con);
            $ResearchArea = test_input($_POST["researchArea"],$con);
            $Supervisor = test_input($_POST["supervisor"],$con);
            $Abstract = test_input($_POST["Abstract"],$con);
