...
<form method="post">
  <br><br><br><br><br>
<label  class="checkbox-inline labelStyle"><input class="checkboxes" id="mphcheck" onclick="mphcheckboxClick()"  type="checkbox" name="program[]" value="mph">MPH</label>&nbsp;&nbsp;&nbsp;
<label class="checkbox-inline labelStyle"><input class="checkboxes" id="biocheck" onclick="msccheckboxClick()" type="checkbox" name="program[]" value="bio">Bio</label>&nbsp;&nbsp;&nbsp;
<label class="checkbox-inline labelStyle"><input class="checkboxes" id="msccheck" onclick="msccheckboxClick()" type="checkbox" name="program[]" value="msc">MSC</label>&nbsp;&nbsp;&nbsp;
<label class="checkbox-inline labelStyle"><input class="checkboxes" id="phdcheck" onclick="msccheckboxClick()" type="checkbox" name="program[]" value="phd">PHD</label>&nbsp;&nbsp;&nbsp;
<br><br><br>
...
<script>
//If Mph is selected, none of the other options should be allowed.
function mphcheckboxClick(){
  if(document.getElementById("mphcheck").checked == true){
      document.getElementById("biocheck").disabled = true;
      document.getElementById("msccheck").disabled = true;
      document.getElementById("phdcheck").disabled = true;
  }
  else {
      document.getElementById("biocheck").disabled = false;
      document.getElementById("msccheck").disabled = false;
      document.getElementById("phdcheck").disabled = false;
  }
}
//Likewise, if any of the MSC options are selected, MPH should not be allowed.
function msccheckboxClick() {
  if(document.getElementById("biocheck").checked == true || document.getElementById("msccheck").checked == true  || document.getElementById("phdcheck").checked == true  ){
      document.getElementById("mphcheck").disabled = true;
  }
  else {
    document.getElementById("mphcheck").disabled = false;
  }
}
</script>
