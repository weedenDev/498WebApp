...
// that student.
        ...
        if ($total > 0){
            ...
            if ($row['Program'] == "Masters in Epidemiology"){
                Header("Location: profileMSC.php");
                die();
...
<!-- start of header -->
    ...
    <center> <h1 class="headerFont">MSC Biostatistics Student Profile</h1> </center>
...
<!-- only show this message on the first visit to this page -->
    ...
    ?>
        ...
        <option value="#">MSC Biostatistics</option>
        ...
        <select style="width: 100px;"  name="Gender"><?php
                ...
                <input type="text" title="Enter Letters`" pattern="[a-zA-Z ]+"  name="citizenship" value="<?php echo $citizenship; ?>"/> <br><br>
                
                <label id="homeProvince" > Home Province: </label>
                <input type="text" title="Enter Letters" pattern="[a-zA-Z ]+"  name="homeProvince" value="<?php echo $homeProvince; ?>"/> <br><br>
        ...
        <input type="text" title="Enter only letters" pattern="[^'\x22><]+" title="No Special Characters (Quotes or Angle Brackets)"  name="UGProgram" value="<?php echo $UGProgram; ?>"/><br><br>


        <h4 class="headerfont boldFont">Funding Information</h4> <br>
                <label id="fundingAmount" >Funding Amount: </label>
                <input type="number" title="Enter only numbers" pattern="[0-9]+"  name="fundingAmount" value="<?php echo $Amount; ?>"/> <br><br>
...
// set all of the variables to "" (to prevent against undefined variables)
   ...
   $StudentID = 
        ...
        if(isset($_POST["submit"])){
            ...
            $Program = "Masters in Biostatistics";
            ...
            echo " <script> location.replace('studentSearchMSC.php'); </script>";
       }
    ?>
</html>