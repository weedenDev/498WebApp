...
<html>
   <head>
    ...
    <center> <h1 class="headerFont">Edit/Add Thesis</h1> </center>
  </head>
<body> 
     <div class="profile">
    <form method="post">
 ...
 <br><br>
	...
	<fieldset>
		...
		<label id="area" >Research Area: </label> <input type="text" pattern="[^'\x22><]+" title="No Special Characters (Quotes or Angle Brackets)" name="researchArea" value="<?php echo $ResearchArea; ?>" > <br><br>
		<label id="supervisor" >Supervisor: </label>  <input type="text" name="supervisor" pattern="[^'\x22><]+" title="No Special Characters (Quotes or Angle Brackets)" value="<?php echo $Supervisor; ?>" > <br><br>
        <label id="defencecommitte" >Defence Committee: </label>  <input type="text" pattern="[^'\x22><]+" title="No Special Characters (Quotes or Angle Brackets)" name="defence" value="<?php echo $Defence; ?>"> <br><br>
        <input type='hidden' name="flaginput" value="<?php if($flag==TRUE){ echo 'true';} else{ echo 'false';}?>">
