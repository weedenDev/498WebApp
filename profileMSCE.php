    ...
    ?>
        ...
        <form method="POST">
            ...
            <legend> Student Information </legend>
                ...
                <input type="text" pattern="[^'\x22><]+" title="No Special Characters (Quotes or Angle Brackets)" name="Qemail" readonly="readonly" value="<?php echo ($_SERVER[HTTP_QUEENSU_NETID]);?>@queensu.ca"/>
                <br>
            ...
            <legend> Undergrad Information </legend>
                ...
                <input type="text" title="No Numbers/Symbols"  pattern="[a-zA-Z ]+" name="UGProgram" value="<?php echo $UGProgram; ?>"/>
                <br>
            </fieldset>
            <br><br>
            <fieldset>
                ...
                <input type="text" title="Enter only numbers" pattern="[^'\x22><]+" title="No Special Characters (Quotes or Angle Brackets)" name="currJobTitle" value="<?php echo $currJobTitle; ?>"/>
                <br>
                <label id="currEmployer" > Current Employer: </label>
                <input type="text" title="Enter letters or numbers" pattern="[^'\x22><]+" title="No Special Characters (Quotes or Angle Brackets)" name="currEmployer" value="<?php echo $currEmployer; ?>"/>
                <br>
            ...
            <legend> Additonal Background Information </legend>
                ...
                <input type="text" title="Enter only letters" pattern="[a-zA-Z ]+" name="citizenship" value="<?php echo $citizenship; ?>"/>
                <br>
                
                <label id="homeProvince" > Home Province: </label>
                <input type="text" title="Enter only letters" pattern="[a-zA-Z ]+" name="homeProvince" value="<?php echo $homeProvince; ?>"/>
                <br>
            ...
            <legend> Funding </legend>
                ...
                <input type="text" pattern="[^\x22><]+" title="No Special Characters (Quotes or Angle Brackets)" name="fundingSource" value="<?php echo $Source; ?>"/>
                <br>
